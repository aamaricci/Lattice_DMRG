program hm_1d
  ...
  real(8),dimension(:,:),allocatable        :: rhoH
  ...
  call parse_input_variable(nkx,"NKX","inputHM.conf",default=100)
  call parse_input_variable(mh,"MH","inputHM.conf",default=0d0)
  call parse_input_variable(lambda,"LAMBDA","inputHM.conf",default=0d0)
  call parse_input_variable(ts,"ts","inputHM.conf",default=-1d0)
  call parse_input_variable(norb,"Norb","inputHM.conf",default=2)
  call parse_input_variable(pbc,"pbc","inputHM.conf",default=.false.)
  call parse_input_variable(beta,"beta","inputHM.conf",default=1000d0)
  ...
  do Nx=2,Nkx,2
     ...
     E0 = E0/Nlat/Nso
     write(*,*)Nlat/2,E0,dens(1),dens(2),kdens(1),kdens(2)
